 ...
 */
public class DatabaseToConsoleStep1Processor implements ItemProcessor<Book, Book> {

    private static final Logger log = LoggerFactory.getLogger(DatabaseToConsoleStep1Processor.class);
